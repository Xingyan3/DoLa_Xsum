        ...
        **model_kwargs,
        ...
        while True:
            ...
            for i, early_exit_layer in enumerate(early_exit_layers):
                # print(outputs.decoder_hidden_states[early_exit_layer].shape)
                dict_outputs[early_exit_layer] = outputs.decoder_hidden_states[early_exit_layer]

            # print(dict_outputs.shape)
            if synced_gpus and this_peer_finished:
                continue  # don't waste resources running the code we don't need
